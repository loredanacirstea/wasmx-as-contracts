...
export const TendermintP2P = {"context":{"log":"","votedFor":"0","nextIndex":"[]","currentTerm":"0","blockTimeout":"roundTimeout","max_tx_bytes":"65536","roundTimeout":4000,"currentNodeId":"0","max_block_gas":"20000000","timeoutPropose":3000,"timeoutPrevote":3000,"timeoutPrecommit":3000},"id":"Tendermint-P2P-5","initial":"uninitialized","states":{"uninitialized":{"on":{"initialize":{"target":"initialized"}}},"initialized":{"initial":"unstarted","states":{"unstarted":{"on":{"setupNode":{"target":"unstarted","actions":{"type":"setupNode"}},"prestart":{"target":"prestart"},"setup":{"target":"unstarted","actions":{"type":"setup"}},"start":{"target":"started","actions":[{"type":"connectPeers"},{"type":"connectRooms"}]}}},"prestart":{"after":{"500":{"target":"started"}}},"started":{"initial":"Node","on":{"newTransaction":{"actions":[{"type":"addToMempool"},{"type":"sendNewTransactionResponse"},{"type":"forwardMsgToChat","params":{"protocolId":"mempool"}}]},"receiveUpdateNodeResponse":{"actions":{"type":"receiveUpdateNodeResponse"}},"receiveStateSyncRequest":{"actions":{"type":"receiveStateSyncRequest"}},"updateNode":{"actions":{"type":"updateNodeAndReturn"}}},"states":{"Node":{"on":{"becomeValidator":{"target":"Validator","actions":[{"type":"registerValidatorWithNetwork"},{"type":"requestNetworkSync"}]},"receiveStateSyncResponse":{"actions":{"type":"receiveStateSyncResponse"}},"start":{"actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"requestNetworkSync"}]},"receiveBlockProposal":{"actions":{"type":"receiveBlockProposal"}},"receiveCommit":{"actions":{"type":"receiveCommit"}}},"always":[{"target":"Validator","actions":[{"type":"registerValidatorWithNetwork"},{"type":"requestNetworkSync"}],"guard":{"type":"ifNodeIsValidator"}},{"actions":{"type":"requestNetworkSync"}}]},"Validator":{"initial":"active","on":{"receiveBlockProposal":{"actions":{"type":"receiveBlockProposal"},"guard":{"type":"ifSenderIsProposer"}},"stop":{"target":"#Tendermint-P2P-5.stopped"},"receiveStateSyncResponse":{"actions":{"type":"receiveStateSyncResponse"}},"receivePrevote":{"actions":{"type":"receivePrevote"}},"start":{"target":"Validator","actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"registerValidatorWithNetwork"},{"type":"requestNetworkSync"}]},"receiveCommit":{"actions":{"type":"receiveCommit"}}},"states":{"active":{"on":{"receiveBlockProposal":{"target":"prevote","actions":[{"type":"receiveBlockProposal"},{"type":"sendPrevote"},{"type":"cancelActiveIntervals","params":{"after":"timeoutPropose"}}],"guard":{"type":"ifSenderIsProposer"}}},"after":{"timeoutPropose":{"target":"prevote","actions":{"type":"sendPrevoteNil"}}},"always":{"target":"#Tendermint-P2P-5.initialized.started.Proposer","guard":{"type":"isNextProposer"}},"entry":[{"type":"incrementCurrentTerm"},{"type":"setRoundProposer"},{"type":"resetPrevotes"},{"type":"resetPrecommits"}]},"prevote":{"on":{"receivePrevote":{"target":"prevote","actions":{"type":"receivePrevote"}}},"after":{"timeoutPrevote":{"target":"precommit","actions":{"type":"sendPrecommitNil"},"guard":{"type":"ifPrevoteAnyThreshold"}}},"always":{"target":"precommit","actions":[{"type":"setLockedValue"},{"type":"setLockedRound"},{"type":"sendPrecommit"},{"type":"setValidValue"},{"type":"setValidRound"},{"type":"cancelActiveIntervals","params":{"after":"timeoutPrevote"}}],"guard":{"type":"ifPrevoteAcceptThreshold"}}},"precommit":{"on":{"receivePrecommit":{"target":"precommit","actions":{"type":"receivePrecommit"}},"receivePrevote":{"actions":{"type":"receivePrevote"}}},"after":{"timeoutPrecommit":{"target":"active","guard":{"type":"ifPrecommitAnyThreshold"}}},"always":{"target":"commit","actions":[{"type":"commitBlock"},{"type":"sendCommit"},{"type":"resetLockedRound"},{"type":"resetValidValue"},{"type":"resetValidRound"},{"type":"cancelActiveIntervals","params":{"after":"timeoutPrecommit"}},{"type":"resetLockedValue"}],"guard":{"type":"ifPrecommitAcceptThreshold"}}},"commit":{"on":{"receivePrecommit":{"actions":{"type":"receivePrecommit"}}},"after":{"roundTimeout":{"target":"active"}}}}},"Proposer":{"initial":"active","on":{"start":{"target":"Validator","actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"registerValidatorWithNetwork"},{"type":"requestNetworkSync"}]},"stop":{"target":"#Tendermint-P2P-5.stopped"}},"states":{"active":{"always":{"target":"#Tendermint-P2P-5.initialized.started.Validator.prevote"},"entry":[{"type":"proposeBlock"},{"type":"sendBlockProposal"},{"type":"sendPrevote"}]}}}}}}},"stopped":{"on":{"restart":{"target":"#Tendermint-P2P-5.initialized.unstarted"}}}}}
