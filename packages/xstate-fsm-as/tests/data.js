...
export const Lobby = {"context":{"heartbeatTimeout":5000,"newchainTimeout":20000,"min_validators_count":2,"enable_eid_check":false,"erc20CodeId":27,"derc20CodeId":28,"level_initial_balance":10000000000000000000},"id":"Lobby-P2P-1","initial":"uninitialized","states":{"uninitialized":{"on":{"initialize":{"target":"initialized"}}},"initialized":{"initial":"unstarted","states":{"unstarted":{"on":{"start":{"target":"started","actions":[{"type":"p2pConnectLobbyRoom"},{"type":"sendNewChainRequest"}]},"setup":{"target":"unstarted","actions":{"type":"setup"}},"prestart":{"target":"prestart"},"setupNode":{"target":"unstarted","actions":{"type":"setupNode"}}}},"started":{"on":{"receiveLastChainId":{"actions":{"type":"receiveLastChainId"}},"receiveLastNodeId":{"actions":{"type":"receiveLastNodeId"}},"receiveNewChainResponse":{"target":"started","actions":{"type":"receiveNewChainResponse"}},"start":{"target":"started","actions":[{"type":"p2pConnectLobbyRoom"},{"type":"sendNewChainRequest"}]},"receiveNewChainRequest":{"actions":{"type":"receiveNewChainRequest"}}},"after":{"newchainTimeout":{"target":"started","actions":{"type":"sendNewChainResponse"}}},"always":{"target":"initializing","actions":[{"type":"p2pConnectNewChainRoom"},{"type":"tryCreateNewChainGenesisData"}],"guard":{"type":"ifValidatorThreshold"}}},"prestart":{"after":{"500":{"target":"started"}}},"initializing":{"on":{"receiveNewChainGenesisData":{"target":"initializing","actions":[{"type":"receiveNewChainGenesisData"},{"type":"sendNewChainGenesisData"}]},"start":{"target":"initializing","actions":{"type":"p2pConnectNewChainRoom"}}},"always":{"target":"initialized","actions":[{"type":"initializeChain"},{"type":"p2pDisconnectNewChainRoom"}],"guard":{"type":"ifGenesisDataComplete"}}},"initialized":{"on":{"receiveLastChainId":{"actions":{"type":"receiveLastChainId"}}},"after":{"heartbeatTimeout":{"target":"initialized","actions":[{"type":"sendLastChainId"},{"type":"sendLastNodeId"}]}},"always":{"target":"done","guard":{"type":"ifLobbyDisconnect"}}},"done":{"entry":{"type":"p2pDisconnectLobbyRoom"}}}}}}
