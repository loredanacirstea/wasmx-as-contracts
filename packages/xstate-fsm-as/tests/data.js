...
export const TendermintP2P = {"context":{"log":"","votedFor":"0","nextIndex":"[]","currentTerm":"0","blockTimeout":"roundTimeout","max_tx_bytes":"65536","roundTimeout":10000,"currentNodeId":"0","max_block_gas":"20000000"},"id":"Tendermint-P2P-4","initial":"uninitialized","states":{"uninitialized":{"on":{"initialize":{"target":"initialized"}}},"initialized":{"initial":"unstarted","states":{"unstarted":{"on":{"setupNode":{"target":"unstarted","actions":{"type":"setupNode"}},"prestart":{"target":"prestart"},"setup":{"target":"unstarted","actions":{"type":"setup"}},"start":{"target":"started","actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"requestNetworkSync"}]}}},"prestart":{"after":{"500":{"target":"started"}}},"started":{"initial":"Node","on":{"newTransaction":{"actions":[{"type":"addToMempool"},{"type":"sendNewTransactionResponse"},{"type":"forwardMsgToChat","params":{"protocolId":"mempool"}}]},"receiveUpdateNodeResponse":{"actions":{"type":"receiveUpdateNodeResponse"}},"receiveStateSyncRequest":{"actions":{"type":"receiveStateSyncRequest"}},"updateNode":{"actions":{"type":"updateNodeAndReturn"}},"start":{"actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"requestNetworkSync"}]}},"states":{"Node":{"on":{"newValidator":[{"target":"Validator","actions":{"type":"transitionNodeToValidator"},"guard":{"type":"newValidatorIsSelf"}},{"target":"Node","actions":{"type":"transitionNodeToValidator"}}],"receiveStateSyncResponse":{"actions":{"type":"receiveStateSyncResponse"}},"receiveBlockProposal":{"actions":{"type":"receiveBlockProposal"}}},"always":{"target":"Validator","guard":{"type":"ifNodeIsValidator"}}},"Validator":{"initial":"active","on":{"receiveBlockProposal":{"actions":[{"type":"receiveBlockProposal"},{"type":"sendPrevote"}],"guard":{"type":"ifSenderIsProposer"}},"stop":{"target":"#Tendermint-P2P-4.stopped"},"receiveStateSyncResponse":{"actions":{"type":"receiveStateSyncResponse"}},"receivePrevote":{"actions":{"type":"receivePrevote"}}},"after":{"roundTimeout":{"target":"Validator"}},"states":{"active":{"on":{"receiveBlockProposal":{"target":"prevote","actions":[{"type":"receiveBlockProposal"},{"type":"sendPrevote"}],"guard":{"type":"ifSenderIsProposer"}}},"always":{"target":"#Tendermint-P2P-4.initialized.started.Proposer","guard":{"type":"isNextProposer"}},"entry":[{"type":"cancelActiveIntervals","params":{"after":"roundTimeout"}},{"type":"incrementCurrentTerm"},{"type":"setRoundProposer"}]},"prevote":{"on":{"receivePrevote":{"target":"prevote","actions":{"type":"receivePrevote"}}},"always":{"target":"precommit","actions":{"type":"sendPrecommit"},"guard":{"type":"ifPrevoteThreshold"}}},"precommit":{"on":{"receivePrecommit":{"target":"precommit","actions":{"type":"receivePrecommit"}}},"always":{"target":"precommit","actions":{"type":"commitBlock"},"guard":{"type":"ifPrecommitThreshold"}}}}},"Proposer":{"initial":"active","on":{"stop":{"target":"#Tendermint-P2P-4.stopped"}},"after":{"roundTimeout":{"target":"Validator"}},"states":{"active":{"on":{"start":{"target":"#Tendermint-P2P-4.initialized.started.Validator","actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"requestNetworkSync"}]}},"always":{"target":"prevote"},"entry":[{"type":"cancelActiveIntervals","params":{"after":"roundTimeout"}},{"type":"proposeBlock"},{"type":"sendBlockProposal"},{"type":"sendPrevote"}]},"prevote":{"on":{"receivePrevote":{"target":"prevote","actions":{"type":"receivePrevote"}}},"always":{"target":"precommit","actions":{"type":"sendPrecommit"},"guard":{"type":"ifPrevoteThreshold"}}},"precommit":{"on":{"receivePrecommit":{"target":"precommit","actions":{"type":"receivePrecommit"}}},"always":{"target":"precommit","actions":{"type":"commitBlock"},"guard":{"type":"ifPrecommitThreshold"}}}}}}}}},"stopped":{"on":{"restart":{"target":"#Tendermint-P2P-4.initialized.unstarted"}}}}}
