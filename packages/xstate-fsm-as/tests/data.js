...
export const Level0 = {"context":{"log":"","votedFor":"0","nextIndex":"[]","currentTerm":"0","blockTimeout":"roundTimeout","max_tx_bytes":"65536","roundTimeout":4000,"currentNodeId":"0","max_block_gas":"20000000","timeoutPropose":3000,"timeoutPrecommit":3000},"id":"Levels-P2P-2","initial":"uninitialized","states":{"uninitialized":{"on":{"initialize":{"target":"initialized"}}},"initialized":{"initial":"unstarted","states":{"unstarted":{"on":{"setupNode":{"target":"unstarted","actions":{"type":"setupNode"}},"prestart":{"target":"prestart"},"setup":{"target":"unstarted","actions":{"type":"setup"}},"start":{"target":"started","actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"requestBlockSync"},{"type":"StartNode"}]}}},"prestart":{"after":{"500":{"target":"started"}}},"started":{"initial":"Node","on":{"newTransaction":{"actions":[{"type":"addToMempool"},{"type":"sendNewTransactionResponse"},{"type":"forwardMsgToChat","params":{"protocolId":"mempool"}}],"guard":{"type":"ifNewTransaction"}},"receiveStateSyncRequest":{"actions":{"type":"receiveStateSyncRequest"}},"updateNode":{"actions":{"type":"updateNodeAndReturn"}}},"states":{"Node":{"on":{"becomeValidator":{"target":"Validator","actions":[{"type":"registerValidatorWithNetwork"},{"type":"requestBlockSync"}]},"receiveStateSyncResponse":{"actions":{"type":"receiveStateSyncResponse"}},"start":{"actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"requestBlockSync"},{"type":"StartNode"}]},"receiveCommit":{"actions":{"type":"receiveCommit"}}},"always":{"target":"Validator","actions":{"type":"registerValidatorWithNetwork"},"guard":{"type":"ifNodeIsValidator"}}},"Validator":{"initial":"active","on":{"receiveBlockProposal":{"actions":{"type":"receiveBlockProposal"},"guard":{"type":"ifSenderIsProposer"}},"stop":{"target":"#Levels-P2P-2.stopped"},"receiveUpdateNodeResponse":{"actions":{"type":"receiveUpdateNodeResponse"}},"start":{"target":"Validator","actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"registerValidatorWithNetwork"},{"type":"requestBlockSync"},{"type":"StartNode"}]},"receiveCommit":{"actions":{"type":"receiveCommit"}},"receiveUpdateNodeRequest":{"actions":{"type":"receiveUpdateNodeRequest"}},"receiveStateSyncResponse":{"actions":[{"type":"receiveStateSyncResponse"},{"type":"requestValidatorNodeInfoIfSynced"}]}},"states":{"active":{"on":{"receiveBlockProposal":{"target":"precommit","actions":[{"type":"receiveBlockProposal"},{"type":"sendPrecommit"},{"type":"cancelActiveIntervals","params":{"after":"timeoutPropose"}}],"guard":{"type":"ifSenderIsProposer"}}},"after":{"timeoutPropose":{"target":"precommit","actions":{"type":"sendPrecommitNil"}}},"always":{"target":"#Levels-P2P-2.initialized.started.Proposer","guard":{"type":"isNextProposer"}},"entry":[{"type":"incrementCurrentTerm"},{"type":"setRoundProposer"},{"type":"resetPrecommits"}]},"precommit":{"on":{"receivePrecommit":{"target":"precommit","actions":{"type":"receivePrecommit"}}},"after":{"timeoutPrecommit":{"target":"active","guard":{"type":"ifPrecommitAnyThreshold"}}},"always":{"target":"commit","actions":[{"type":"commitBlock"},{"type":"sendCommit"},{"type":"cancelActiveIntervals","params":{"after":"timeoutPrecommit"}}],"guard":{"type":"ifPrecommitAcceptThreshold"}}},"commit":{"on":{"receivePrecommit":{"actions":{"type":"receivePrecommit"}}},"after":{"roundTimeout":{"target":"active"}}}}},"Proposer":{"initial":"active","on":{"start":{"target":"Validator","actions":[{"type":"connectPeers"},{"type":"connectRooms"},{"type":"registerValidatorWithNetwork"},{"type":"requestBlockSync"},{"type":"StartNode"}]},"stop":{"target":"#Levels-P2P-2.stopped"},"receiveUpdateNodeRequest":{"actions":{"type":"receiveUpdateNodeRequest"}}},"states":{"active":{"always":{"target":"#Levels-P2P-2.initialized.started.Validator.precommit"},"entry":[{"type":"proposeBlock"},{"type":"sendBlockProposal"},{"type":"sendPrecommit"}]}}}}}}},"stopped":{"on":{"restart":{"target":"#Levels-P2P-2.initialized.unstarted"}}}}}

export const Lobby = {"context":{"heartbeatTimeout":5000,"newchainTimeout":20000,"min_validators_count":2,"enable_eid_check":false,"erc20CodeId":27,"derc20CodeId":28,"level_initial_balance":10000000000000000000},"id":"Lobby-P2P-1","initial":"uninitialized","states":{"uninitialized":{"on":{"initialize":{"target":"initialized"}}},"initialized":{"initial":"unstarted","states":{"unstarted":{"on":{"start":{"target":"started","actions":[{"type":"p2pConnectLobbyRoom"},{"type":"sendNewChainRequest"}]},"setup":{"target":"unstarted","actions":{"type":"setup"}},"prestart":{"target":"prestart"},"setupNode":{"target":"unstarted","actions":{"type":"setupNode"}}}},"started":{"initial":"requesting","on":{"receiveLastChainId":{"actions":{"type":"receiveLastChainId"}},"receiveLastNodeId":{"actions":{"type":"receiveLastNodeId"}},"start":{"target":"started","actions":[{"type":"p2pConnectLobbyRoom"},{"type":"sendNewChainRequest"}]}},"states":{"requesting":{"on":{"receiveNewChainResponse":{"target":"negotiating","actions":{"type":"receiveNewChainResponse"},"guard":{"type":"ifIncludesUs"}},"receiveNewChainRequest":{"actions":{"type":"receiveNewChainRequest"}}},"after":{"newchainTimeout":{"target":"negotiating","actions":[{"type":"createNewChainResponse"},{"type":"sendNewChainResponse"}]}}},"negotiating":{"on":{"receiveNewChainResponse":{"target":"negotiating","actions":{"type":"receiveNewChainResponse"},"guard":{"type":"ifIncludesUs"}},"receiveNewChainRequest":{"actions":[{"type":"receiveNewChainRequest"},{"type":"sendNewChainResponse"}]}},"always":{"target":"#Lobby-P2P-1.initialized.initializing","actions":[{"type":"p2pConnectNewChainRoom"},{"type":"tryCreateNewChainGenesisData"}],"guard":{"type":"ifValidatorThreshold"}}}}},"prestart":{"after":{"500":{"target":"started"}}},"initializing":{"on":{"receiveNewChainGenesisData":{"target":"initializing","actions":{"type":"receiveNewChainGenesisData"}},"start":{"target":"initializing","actions":{"type":"p2pConnectNewChainRoom"}},"addGenTx":{"target":"initializing","actions":{"type":"addGenTx"}}},"always":{"target":"initialized","actions":[{"type":"initializeChain"},{"type":"p2pDisconnectNewChainRoom"}],"guard":{"type":"ifGenesisDataComplete"}}},"initialized":{"on":{"receiveLastChainId":{"actions":{"type":"receiveLastChainId"}}},"after":{"heartbeatTimeout":{"target":"initialized","actions":[{"type":"sendLastChainId"},{"type":"sendLastNodeId"}]}},"always":{"target":"done","guard":{"type":"ifLobbyDisconnect"}}},"done":{"entry":{"type":"p2pDisconnectLobbyRoom"}}}}}}
