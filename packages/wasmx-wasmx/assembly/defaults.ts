...
export const level0InitMsg = wasmxExecMsg(`{"instantiate":{"context":[{"key":"maxLevel","value":0},{"key":"blockTimeoutInternal","value":3000},{"key":"currentLevel","value":0},{"key":"membersCount","value":1},{"key":"blockTimeout","value":"blockTimeoutInternal"}],"initialState":"uninitialized"}}`)
